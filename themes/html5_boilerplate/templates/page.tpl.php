<div id="page">
  ...
  <div id="main-wrapper" class="clearfix">
     ...
     */
    ?>  
    <section id="main-content" class="<?php print $page['sidebar_second'] ? 'grid-7' : 'grid-10 last-col' ; ?>" role="main">
  ...
  <?php if ($footer = render($page['footer'])): ?>
    <footer class="clearfix" role="contentinfo"><?php print $footer; ?></footer>
  <?php endif; ?>
